use super::flavors::{RosePineFlavor, RosePineFlavorNames};
use super::img::Color;

#[derive(Clone, Copy, Debug)]
pub(crate) struct Palette {
    pub(crate) default: RosePineFlavor,
    pub(crate) dawn: RosePineFlavor,
    pub(crate) moon: RosePineFlavor,
}

impl Palette {
    pub fn get_flavor(self, name: &RosePineFlavorNames) -> RosePineFlavor {
        match name {
            RosePineFlavorNames::Default => self.default,
            RosePineFlavorNames::Dawn => self.dawn,
            RosePineFlavorNames::Moon => self.moon,
        }
    }
}

pub const PALETTES: Palette = Palette {
    default: RosePineFlavor {
