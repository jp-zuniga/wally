...
impl Palette {
    pub(crate) fn tokyo_night() -> Self {
        Palette {
            ...
            base: Color::from_u8(0x1a, 0x1b, 0x26),       // #1a1b26
    ...
    pub(crate) fn tokyo_storm() -> Self {
        Palette {
            foreground: Color::from_u8(0xc0, 0xca, 0xf5), // #c0caf5
            accent: Color::from_u8(0x2e, 0x3c, 0x64),     // #2e3c64
            base: Color::from_u8(0x24, 0x28, 0x3b),       // #24283b
