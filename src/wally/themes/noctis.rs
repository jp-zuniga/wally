...
impl Palette {
    ...
    pub(crate) fn noctis_sereno() -> Self {
        Palette {
            foreground: Color::from_u8(0xb2, 0xca, 0xcd), // #b2cacd
            base: Color::from_u8(0x09, 0x40, 0x47),       // #094047
            accent: Color::from_u8(0x04, 0x1d, 0x20),     // #041d20
            black: Color::from_u8(0x32, 0x4a, 0x4d),      // #324a4d
            red: Color::from_u8(0xe6, 0x65, 0x33),        // #e66533
            green: Color::from_u8(0x49, 0xe9, 0xa6),      // #49e9a6
            yellow: Color::from_u8(0xe4, 0xb7, 0x81),     // #e4b781
    ...
    pub(crate) fn noctis_minimus() -> Self {
        Palette {
            ...
            base: Color::from_u8(0x21, 0x35, 0x41),       // #213541
            accent: Color::from_u8(0x0e, 0x19, 0x20),     // #0e1920
    ...
    pub(crate) fn noctis_obscuro() -> Self {
        Palette {
            foreground: Color::from_u8(0xb2, 0xca, 0xcd), // #b2cacd
            base: Color::from_u8(0x07, 0x34, 0x3a),       // #07343a
            accent: Color::from_u8(0x02, 0x0c, 0x0e),     // #020c0e
            black: Color::from_u8(0x32, 0x4a, 0x4d),      // #324a4d
            red: Color::from_u8(0xe6, 0x65, 0x33),        // #e66533
            green: Color::from_u8(0x49, 0xe9, 0xa6),      // #49e9a6
            yellow: Color::from_u8(0xe4, 0xb7, 0x81),     // #e4b781
    ...
    pub(crate) fn noctis_azureus() -> Self {
        Palette {
            ...
            base: Color::from_u8(0x0b, 0x3a, 0x58),       // #0b3a58
            accent: Color::from_u8(0x05, 0x1b, 0x29),     // #051b29
    ...
    pub(crate) fn noctis_uva() -> Self {
        Palette {
            ...
            base: Color::from_u8(0x39, 0x35, 0x58),       // #393558
            accent: Color::from_u8(0x1f, 0x1d, 0x30),     // #1f1d30
    ...
    pub(crate) fn noctis_viola() -> Self {
        Palette {
            ...
            base: Color::from_u8(0x48, 0x35, 0x5b),       // #48355b
            accent: Color::from_u8(0x29, 0x1d, 0x35),     // #291d35
    ...
    pub(crate) fn noctis_bordo() -> Self {
        Palette {
            ...
            base: Color::from_u8(0x4d, 0x3c, 0x42),       // #4d3c42
            accent: Color::from_u8(0x27, 0x20, 0x22),     // #272022
    ...
    pub(crate) fn noctis_hibernus() -> Self {
        Palette {
            ...
            base: Color::from_u8(0xc9, 0xe8, 0xed),       // #c9e8ed
            accent: Color::from_u8(0xe1, 0xee, 0xef),     // #e1eeef
    ...
    pub(crate) fn noctis_lilac() -> Self {
        Palette {
            ...
            base: Color::from_u8(0xe9, 0xe7, 0xf3),       // #e9e7f3
            accent: Color::from_u8(0xd0, 0xcc, 0xef),     // #d0ccef
    ...
    pub(crate) fn noctis_lux() -> Self {
        Palette {
            foreground: Color::from_u8(0x00, 0x56, 0x61), // #005661
            base: Color::from_u8(0xf6, 0xed, 0xda),       // #f6edda
            accent: Color::from_u8(0xd4, 0xe8, 0xe2),     // #d4e8e2
            black: Color::from_u8(0x00, 0x3b, 0x42),      // #003b42
            red: Color::from_u8(0xe3, 0x4e, 0x1c),        // #e34e1c
            green: Color::from_u8(0x00, 0xb3, 0x68),      // #00b368
            yellow: Color::from_u8(0xf4, 0x97, 0x25),     // #f49725
